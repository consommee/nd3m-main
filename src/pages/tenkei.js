...
const indexQuery = graphql`
  query {
    ...
    tenkei-logo: file(relativePath: { eq: "tenkei/tenkei-logo.png" }) {
      childImageSharp {
    ...
    step1-photograph: file(relativePath: { eq: "tenkei/step1-photograph.png" }) {
      childImageSharp {
	...
	step2-upload: file(relativePath: { eq: "tenkei/step2-upload.png" }) {
      childImageSharp {
        fluid(maxWidth: 1000, quality: 100) {
          ...GatsbyImageSharpFluid
          ...GatsbyImageSharpFluidLimitPresentationSize
	...
	step3-3dmodel: file(relativePath: { eq: "tenkei/step3-3dmodel.png" }) {
      childImageSharp {
        fluid(maxWidth: 1000, quality: 100) {
          ...GatsbyImageSharpFluid
          ...GatsbyImageSharpFluidLimitPresentationSize
	...
	step4-reach file(relativePath: { eq: "tenkei/step4-reach.png" }) {
      childImageSharp {
        fluid(maxWidth: 1000, quality: 100) {
          ...GatsbyImageSharpFluid
          ...GatsbyImageSharpFluidLimitPresentationSize
